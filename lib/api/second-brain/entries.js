...
import { GLOBALLY_PERMISSIVE_TAGS_NORMALIZED } from "../../constants/tags.js";
...
export default async function handler(req, res) {
  ...
  if (req.method === "GET") {
    try {
      ...
      const includeStats =
        rawIncludeStats === "true" || rawIncludeStats === "1";
      ...
      return json(res, 200, {
        ...
        ...(includeStats
          ? { stats: await getEntryCategoryCounts(userId, token) }
          : {}),
      });
    } catch (err) {
